...
const StockActionMenu = ({ stock, onEdit, onDelete, onToggleStatus }) => {
  return (
    <div style={{
      position: 'absolute',
      top: '30px',
      ...
      <div style={{ ...menuItemStyle, borderBottom: '1px solid #E0E0E0' }} onClick={() => onEdit(stock.id)}>
        Edit
      ...
      <div style={{ ...menuItemStyle, borderBottom: '1px solid #E0E0E0' }} onClick={() => onDelete(stock.id)}>
        Delete
      ...
      <div
          ...
          onClick={() => onToggleStatus(stock.id, stock.status)}
      >
          {stock.status === 'In Stock' ? 'No Stock' : 'In Stock'}
