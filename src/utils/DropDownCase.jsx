...
const CaseActionMenu = ({ casebill, onEdit, onDelete, onPrintBill }) => {
  return (
    <div style={{
      position: 'absolute',
      top: '30px',
      ...
      <div style={{ ...menuItemStyle, borderBottom: '1px solid #E0E0E0' }} onClick={() => onEdit(casebill.id)}>
        Edit
      ...
      <div style={{ ...menuItemStyle, borderBottom: '1px solid #E0E0E0' }} onClick={() => onDelete(casebill.id)}>
        Delete
      ...
      <div style={{ ...menuItemStyle, borderBottom: '1px solid #E0E0E0' }} onClick={() => onPrintBill(casebill.id)}>
      Print Bill
      <svg width="14" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11 6.58406V17.233H3V6.58406H11ZM9.5 0.194702H4.5L3.5 1.2596H0V3.38938H14V1.2596H10.5L9.5 0.194702ZM13 4.45428H1V17.233C1 18.4044 1.9 19.3628 3 19.3628H11C12.1 19.3628 13 18.4044 13 17.233V4.45428Z" fill="#FF1616"/>
      </svg>
